...
class TNCHeadClassifierTrain(LightningTrainMLFlow):
...
class TNCHeadClassifierFineTune(LightningFineTuneMLFlow):
    MODEL = "TNCPredictionHead"
...
if __name__ == "__main__":
    options = {
        "train": TNCHeadClassifierTrain,
        "finetune": TNCHeadClassifierFineTune,
    }
    auto_main(options)