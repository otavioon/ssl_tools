...
class LSTMAutoencoderAnomalyDetectionTrain(CovidAnomalyDetectionTrain):
    _MODEL_NAME = "lstm-ae"
...
class LSTMAutoencoderAnomalyDetectionTest(CovidAnomalyDetectionEvaluator):
    _MODEL_NAME = "lstm-ae"
...
if __name__ == "__main__":
    options = {
        "fit": LSTMAutoencoderAnomalyDetectionTrain,
        "test": LSTMAutoencoderAnomalyDetectionTest,
    }
