...
tfc_pretrain_checkpoint = checkpoint_dir / "tfc_pretrain"
tfc_classifier_checkpoint = checkpoint_dir / "tfc_classifier"
result_dir = Path("results/")
result_dir.mkdir(exist_ok=True, parents=True)
results_tfc_classifier = result_dir / "tfc_classifier.yaml"
...
batch_size = 64 # 60 is the original value. I have adjusted to 512 to maximize GPU usage
n_classes = 5
